            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Cloud Academy</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" autocomplete="off" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Sign in as user? <a href="index.php">Login here</a></p>
              ...
              if (!empty($_REQUEST['uid'])) {
                ...
                $q = "SELECT * FROM admin_users where username='".$username."' AND password = '".$pass."'" ;
                //echo $q;
              ...
              <div class="credits">
                ...
                Developed by d4rkpackt & learzA</a>
              </div>
